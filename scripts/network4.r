...
imag$term_abbrev = sub(x = imag$term, 'imaginar(y|ies)*$', 'Im', ignore.case=TRUE)
...
svg('../figures/network12.svg', 10, 8)
...
text('Authors (in blue); imaginary terms (in green) abbreviated to I.', x=-14, y=-37, cex=0.7 )
dev.off()
